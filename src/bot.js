...
const serverId = "1336760362489483414";
const subscriptionChannelId = "1336766847403560980";
const categoryId = "1336766689974550538"; // The category ID for the private channels
const subscriberRoleId = "1338781754894454820";
const JOIN_REQUEST_CHANNEL = "1347901401514119239";
...
export async function createPrivateChannelAndSendDM(
  ...
  try {
    ...
    const request = await channel.guild.channels.fetch(JOIN_REQUEST_CHANNEL);
...
client.once("ready", async () => {
  ...
  await sendSubscriptionMessage(subscriptionChannelId);
